...
You may notice but the publication date that this yearly post is a _little_ bit late. To say the very least, life has been busy for me. I'll digress on the exact details for now, but in the mean time, here's an update on what I've been up to.
